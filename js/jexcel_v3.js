 ...
 *
 * The distribution of this software is limited. It requires a licence. For more information visit the website.
 *
...
var jexcel = (function(el, options) {
    ...
    obj.createTable = function() {
        ...
        // Powered by jExcel
        var ads = '<a href="https://jexcel.net/"><img src="//jexcel.net/v3/logo.png">jExcel Pro Spreadsheet</a>';
    ...
    obj.paste = function(x, y, data) {
        ...
        if (typeof(obj.options.onbeforepaste) == 'function') {
            data = obj.options.onbeforepaste(data);
        }
    ...
    obj.init = function() {
        ...
        if (obj.options.csv) {
            // Load CSV file
            fetch(obj.options.csv, { headers: new Headers({ 'content-type': 'text/json' }) })
                .then(function(data) {
